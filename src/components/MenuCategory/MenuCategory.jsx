...
const MenuCategory = () => {
  function SampleNextArrow(props) {
    const { onClick } = props;
    return (
      <div className="absolute right-4 top-1/2 -translate-y-1/2 z-40" onClick={onClick}>
  ...
  function SamplePrevArrow(props) {
    const { onClick } = props;
    return (
      <div className="absolute left-4 top-1/2 cursor-pointer -translate-y-1/2 z-40" onClick={onClick}>
